...
5.times do
  ...
  4.times do
    page1.sections.create(article_title: Faker::Lorem.word, body: Faker::Lorem.paragraph)
  end
end
...
5.times do
  ...
  4.times do
    page2.sections.create(article_title: Faker::Lorem.word, body: Faker::Lorem.paragraph)
  end
end
...
5.times do
  ...
  4.times do
    page3.sections.create(article_title: Faker::Lorem.word, body: Faker::Lorem.paragraph)
  end
end
